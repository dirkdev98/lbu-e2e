...
export const todoMocks = {
    ...
    return _mocker.pickone([
      {
        ...
        items: _mocker.pickone([
          Array.from({ length: _mocker.integer({ min: 0, max: 15 }) }, () =>
            _mocker.pickone([todoMocks.itemOptional()])
          ),
        ]),
      },
    ]);
    ...
    return _mocker.pickone([
      Object.fromEntries(
        _mocker.pickone([
          Array.from({ length: _mocker.integer({ min: 2, max: 15 }) }, () => [
            _mocker.pickone([_mocker.word({})]),
            _mocker.pickone([todoMocks.listOptional()]),
          ]),
        ])
      ),
    ]);
  ...
  allResponseOptional: () => {
    return _mocker.pickone([
      { store: _mocker.pickone([todoMocks.collectionOptional()]) },
    ]);
  },
   ...
   */
  listResponseOptional: () => {
    return _mocker.pickone([
      { todo: _mocker.pickone([todoMocks.listOptional()]) },
    ]);
  },
...
export const unimplementedMocks = {
   ...
   * @return { UnimplementedUser_Optional}
   */
  userOptional: () => {
    return _mocker.pickone([
      {
    ...
    return _mocker.pickone([
      {
        ...
        direction: _mocker.pickone([
          unimplementedMocks.windDirectionOptional(),
        ]),
        totalMess: _mocker.pickone([
          Array.from({ length: _mocker.integer({ min: 0, max: 15 }) }, () =>
            _mocker.pickone([
   ...
   * @return { UnimplementedWindDirection_Optional}
   */
  windDirectionOptional: () => {
