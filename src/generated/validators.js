...
export const todoValidators = {
  ...
  item: (value, propertyPath = "$") => {
    ...
    result = objectValidator7(result, propertyPath);
...
function stringValidator5(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function referenceValidator6(value, propertyPath, parentType = "reference") {
  if (isNil(value)) {
    throw _errorFn("validator.reference.undefined", { propertyPath });
  }
...
function genericValidator4(value, propertyPath, parentType = "generic") {
  ...
  for (const key of Object.keys(value)) {
    const validatedKey = stringValidator5(key, propertyPath + ".$key");
    const validatedValue = referenceValidator6(
      value[key],
      propertyPath + ".$value",
    );
...
function booleanValidator8(value, propertyPath, parentType = "boolean") {
  if (isNil(value)) {
    return false;
  }
...
function stringValidator9(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function objectValidator7(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
  ...
  result["completed"] = booleanValidator8(
    value["completed"],
    propertyPath + "." + "completed",
  );

  result["name"] = stringValidator9(value["name"], propertyPath + "." + "name");

  return result;
}

function referenceValidator11(value, propertyPath, parentType = "reference") {
  if (isNil(value)) {
    throw _errorFn("validator.reference.undefined", { propertyPath });
  }
...
function stringValidator13(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function referenceValidator15(value, propertyPath, parentType = "reference") {
  if (isNil(value)) {
    throw _errorFn("validator.reference.undefined", { propertyPath });
  }
...
function objectValidator14(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function stringValidator17(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function objectValidator16(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function stringValidator19(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function objectValidator18(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function numberValidator21(value, propertyPath, parentType = "number") {
  if (isNil(value)) {
...
function objectValidator20(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function booleanValidator23(value, propertyPath, parentType = "boolean") {
  if (isNil(value)) {
...
function objectValidator22(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function stringValidator26(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function uuidValidator25(value, propertyPath, parentType = "uuid") {
  if (isNil(value)) {
    throw _errorFn("validator.uuid.undefined", { propertyPath });
  }

  return stringValidator26(value, propertyPath, parentType);
}

function stringValidator27(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    throw _errorFn("validator.string.undefined", { propertyPath });
  }
...
function objectValidator24(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function booleanValidator30(value, propertyPath, parentType = "boolean") {
  if (isNil(value)) {
    return true;
  }
...
function numberValidator31(value, propertyPath, parentType = "number") {
  if (isNil(value)) {
    throw _errorFn("validator.number.undefined", { propertyPath });
  }
...
function referenceValidator32(value, propertyPath, parentType = "reference") {
  if (isNil(value)) {
    throw _errorFn("validator.reference.undefined", { propertyPath });
  }
...
function numberValidator35(value, propertyPath, parentType = "number") {
  if (isNil(value)) {
    return;
  }
...
function stringValidator36(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
...
function booleanValidator38(value, propertyPath, parentType = "boolean") {
  if (isNil(value)) {
    return false;
  }
...
function arrayValidator37(value, propertyPath, parentType = "array") {
  if (isNil(value)) {
    throw _errorFn("validator.array.undefined", { propertyPath });
  }
...
function booleanValidator40(value, propertyPath, parentType = "boolean") {
  if (isNil(value)) {
    return;
  }
...
function objectValidator39(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function anyOfValidator34(value, propertyPath, parentType = "anyOf") {
  if (isNil(value)) {
...
function arrayValidator33(value, propertyPath, parentType = "array") {
  if (isNil(value)) {
    throw _errorFn("validator.array.undefined", { propertyPath });
  }
...
function objectValidator29(value, propertyPath, parentType = "object") {
  if (isNil(value)) {
    throw _errorFn("validator.object.undefined", { propertyPath });
  }
...
function stringValidator41(value, propertyPath, parentType = "string") {
  if (isNil(value)) {
    return "NORTH";
  }
